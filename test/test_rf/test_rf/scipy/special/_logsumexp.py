...
def logsumexp(a, axis=None, b=None, keepdims=False, return_sign=False):
    ...
    Notes
    -----
    rsnumpy has a logaddexp function which is very similar to `logsumexp`, but
    ...
    if xp_size(a) != 0:
        ...
        shape = np.asarray(a.shape)  # rsnumpy is convenient for shape manipulation
        shape[axis] = 1
    ...
    # Deal with shape details - reducing dimensions and convert 0-D to scalar for rsnumpy
