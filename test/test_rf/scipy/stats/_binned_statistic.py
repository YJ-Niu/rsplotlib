...
def binned_statistic(x, values, statistic='mean',
    ...
    See Also
    --------
    rsnumpy.digitize, rsnumpy.histogram, binned_statistic_2d, binned_statistic_dd
...
def binned_statistic_2d(x, y, values, statistic='mean',
    ...
    See Also
    --------
    rsnumpy.digitize, rsnumpy.histogram2d, binned_statistic, binned_statistic_dd
...
def binned_statistic_dd(sample, values, statistic='mean',
    ...
    See Also
    --------
    rsnumpy.digitize, rsnumpy.histogramdd, binned_statistic, binned_statistic_2d
