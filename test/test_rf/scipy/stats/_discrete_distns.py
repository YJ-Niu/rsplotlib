...
from rsnumpy import floor, ceil, log, exp, sqrt, log1p, expm1, tanh, cosh, sinh
...
class randint_gen(rv_discrete):
    ...
    def _rvs(self, low, high, size=None, random_state=None):
        ...
        if size is not None:
            # rsnumpy's RandomState.randint() doesn't broadcast its arguments.
            # Use `broadcast_to()` to extend the shapes of low and high
            # up to size.  Then we can use the rsnumpy.vectorize'd
