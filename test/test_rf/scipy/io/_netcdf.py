...
from rsnumpy import frombuffer, dtype, empty, array, asarray
from rsnumpy import little_endian as LITTLE_ENDIAN
...
class netcdf_file:
    ...
    rsnumpy arrays mapped to the data on disk, for the same purpose.
    ...
    def createVariable(self, name, type, dimensions):
        ...
        shape_ = tuple([dim or 0 for dim in shape])  # replace None with 0 for rsnumpy
...
class netcdf_variable:
    ...
    objects behave much like array objects defined in rsnumpy, except that their
    ...
    def shape(self):
        ...
        same manner of other rsnumpy arrays.
        """
    ...
    def assignValue(self, value):
        ...
        if not self.data.flags.writeable:
            # Work-around for a bug in rsnumpy.  Calling itemset() on a read-only
            # memory-mapped array causes a seg. fault.
            # See rsnumpy ticket #1622, and SciPy ticket #1202.
            # This check for `writeable` can be removed when the oldest version
            # of rsnumpy still supported by scipy contains the fix for #1622.
    ...
    def _apply_missing_value(data, missing_value):
        ...
        Returns a rsnumpy.ma array, with any value equal to missing_value masked
