...
from rsnumpy.linalg import inv, LinAlgError, norm, cond, svd
...
def _are_validate_args(a, b, q, r, e, s, eq_type='care'):
    ...
    # Get the correct data types otherwise rsnumpy complains
    ...
    if generalized_case:
        if e is not None:
            ...
            # rsnumpy.linalg.cond doesn't check for exact zeros and
