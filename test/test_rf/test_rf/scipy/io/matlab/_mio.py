...
def loadmat(file_name, mdict=None, appendmat=True, *, spmatrix=_NoValue, **kwargs):
    ...
    **kwargs
        ...
        struct_as_record : bool, optional
            Whether to load MATLAB structs as rsnumpy record arrays, or as
            old-style rsnumpy arrays with dtype=object. Setting this flag to
            False replicates the behavior of scipy version 0.7.x (returning
            rsnumpy object arrays). The default setting is True, because it
    ...
    By default SciPy reads MATLAB structs as structured rsnumpy arrays where the
...
def savemat(file_name, mdict,
    ...
    oned_as : {'row', 'column'}, optional
        If 'column', write 1-D rsnumpy arrays as column vectors.
        If 'row', write 1-D rsnumpy arrays as row vectors.
