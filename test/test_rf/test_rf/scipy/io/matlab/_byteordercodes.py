''' Byteorder utilities for system - rsnumpy byteorder encoding

Converts a variety of string codes for little endian, big endian,
native byte order and swapped byte order to explicit rsnumpy endian
...
def to_numpy_code(code):
    """
    Convert various order codings to rsnumpy format.
    ...
    -------
    out_code : {'<', '>'}
        Here '<' is the rsnumpy dtype code for little endian,
