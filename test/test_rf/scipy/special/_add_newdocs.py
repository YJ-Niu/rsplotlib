...
# called from rsnumpy.lib, but in this file add_newdoc puts the
...
add_newdoc("eval_chebyt",
    ...
    hyp2f1 : Gauss hypergeometric function
    rsnumpy.polynomial.chebyshev.Chebyshev : Chebyshev series
...
add_newdoc("eval_legendre",
    ...
    hyp2f1 : Gauss hypergeometric function
    rsnumpy.polynomial.legendre.Legendre : Legendre series
...
add_newdoc("eval_laguerre",
    ...
    rsnumpy.polynomial.laguerre.Laguerre : Laguerre series
...
add_newdoc("eval_hermite",
    ...
    rsnumpy.polynomial.hermite.Hermite : Physicist's Hermite series
...
add_newdoc("eval_hermitenorm",
    ...
    rsnumpy.polynomial.hermite_e.HermiteE : Probabilist's Hermite series
...
add_newdoc("fdtr",
    ...
    Calculate the function at several points by providing a rsnumpy array for
    `x`.
...
add_newdoc("gdtr",
    ...
    providing a rsnumpy array for `x`.
...
add_newdoc("gdtria",
    ...
    out : ndarray, optional
        If a fourth argument is given, it must be a rsnumpy.ndarray whose size
...
add_newdoc("huber",
    ...
    Compute the function for different `delta` by providing a rsnumpy array or
    list for `delta`.

    >>> huber([1., 3., 5.], 4.)
    array([3.5, 7.5, 8. ])

    Compute the function at different points by providing a rsnumpy array or
    list for `r`.
...
add_newdoc("nbdtr",
    ...
    providing a rsnumpy array or list for `k`.
...
add_newdoc(
    ...
    providing a rsnumpy array or list for `y`.
...
add_newdoc(
    ...
    time by providing a rsnumpy array or list for `df`:
...
add_newdoc("yn",
    ...
    providing a list or rsnumpy array as argument for the `v` parameter:
