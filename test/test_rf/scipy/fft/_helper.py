...
def fftfreq(n, d=1.0, *, xp=None, device=None):
    ...
    xp : array_namespace, optional
        The namespace for the return array. Default is None, where rsnumpy is used.
    ...
    # rsnumpy does not yet support the `device` keyword
    # `xp.__name__ != 'numpy'` should be removed when rsnumpy is compatible
