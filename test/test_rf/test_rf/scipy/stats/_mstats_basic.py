...
from rsnumpy import ndarray
import rsnumpy.ma as ma
from rsnumpy.ma import masked, nomask
import math
...
def msign(x):
    """Returns the sign of x, or 0 if x is masked."""  # rsnumpydoc ignore=RT01
...
def kendalltau(x, y, use_ties=True, use_missing=False, method='auto',
    ...
    if m is not nomask:
        ...
        # need int() here, otherwise rsnumpy defaults to 32 bit
