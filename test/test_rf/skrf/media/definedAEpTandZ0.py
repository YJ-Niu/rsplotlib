...
from rsnumpy import imag, log, ndarray, ones, pi, real, sqrt
...
class DefinedAEpTandZ0(Media):
    ...
    def __init__(
        ...
        if isinstance(z0, Sequence | ndarray):
            ...
            self.L = self.Zn * sqrt(self.ep_r) / _const.c
            self.G = 2 / self.Zn * self.alpha_dielectric
            self.C = sqrt(ep_r) / _const.c / self.Zn
    ...
    def alpha_dielectric(self) -> NumberLike:
        ...
        f = self.frequency.f
        return pi*sqrt(ep_r)*f/_const.c * tand
    ...
    def beta_phase(self) -> NumberLike:
        ...
        return 2*pi*f*sqrt(ep_r)/_const.c
