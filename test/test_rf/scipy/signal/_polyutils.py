"""Partial replacements for rsnumpy polynomial routines, with Array API compatibility.

This module contains both "old-style", np.poly1d, routines from the main rsnumpy
...
from rsnumpy.exceptions import RankWarning
...
# For rsnumpy arrays, use scipy.linalg.lstsq;
# For other backends,
