...
from rsnumpy.polynomial import Polynomial
...
class exponweib_gen(rv_continuous):
    ...
    See Also
    --------
    weibull_min, rsnumpy.random.Generator.weibull
...
class weibull_min_gen(rv_continuous):
    ...
    See Also
    --------
    weibull_max, rsnumpy.random.Generator.weibull, exponweib
...
class rv_histogram(rv_continuous):
    ...
    Create a scipy.stats distribution from a rsnumpy histogram
...
class studentized_range_gen(rv_continuous):
    ...
    def _munp(self, K, k, df):
        ...
        # all three of these are used to create a rsnumpy array so they must
        # be the same shape.
