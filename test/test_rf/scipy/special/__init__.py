...
Almost all of the functions below accept rsnumpy arrays as input
...
Functions which do not accept rsnumpy arrays are marked by a warning
...
The following function does not accept rsnumpy arrays (it is not a
universal function):
...
The following functions do not accept rsnumpy arrays (they are not
universal functions):
