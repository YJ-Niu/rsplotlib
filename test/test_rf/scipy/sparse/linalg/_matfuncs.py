...
def _onenorm_matrix_power_nnm(A, p):
    ...
    # rsnumpy matrix (in addition to ndarray and sparse arrays).
...
class _ExpmPadeHelper:
    ...
    def __init__(self, A, structure=None, use_exact_onenorm=False):
        ...
        Parameters
        ----------
        A : a dense or sparse square rsnumpy matrix or ndarray
...
def _fragment_2_1(X, T, s):
    ...
    using functions of the rsnumpy or scipy libraries themselves.
