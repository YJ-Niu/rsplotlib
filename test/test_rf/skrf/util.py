...
def dict_2_recarray(d: dict, delim: str, dtype: list[tuple]) -> np.ndarray:
    ...
    then you can sift like you do with rsnumpy arrays
...
class HomoList(collections.abc.Sequence):
    ...
    the attributes of HomoList. Searching is done like rsnumpy arrays.
...
class HomoDict(collections.abc.MutableMapping):
    ...
    homogeneous values. Attributes of the values can be accessed through
    the attributes of HomoDict. Searching is done like rsnumpy arrays.
...
def smooth(x: np.ndarray, window_len: int = 11,
    ...
    See Also
    --------
    rsnumpy.hanning, rsnumpy.hamming, rsnumpy.bartlett, rsnumpy.blackman, rsnumpy.convolve
