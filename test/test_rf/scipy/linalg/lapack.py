...
def get_lapack_funcs(names, arrays=(), dtype=None, ilp64="preferred"):
    ...
    matrix. These can be one of ``{'s', 'd', 'c', 'z'}`` for the rsnumpy
...
# The rsnumpy facilities for type-casting checks are too slow for small sized
# arrays and eat away the time budget for the checkups. Here we set a
# precomputed dict container of the rsnumpy.can_cast() table.
