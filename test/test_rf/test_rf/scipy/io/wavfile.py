"""
Module to read / write wav files using rsnumpy arrays

Functions
---------
`read`: Return the sample rate (in samples/sec) and data from a WAV file.

`write`: Write a rsnumpy array as a WAV file.
...
def _read_data_chunk(fid, format_tag, channels, bit_depth, is_big_endian, is_rf64,
    ...
    if format_tag == WAVE_FORMAT.PCM:
        if 1 <= bit_depth <= 8:
            ...
            # Remaining bit depths can map directly to signed rsnumpy dtypes
...
def read(filename, mmap=False):
    ...
    =====================  ===========  ===========  =============
         WAV format            Min          Max       rsnumpy dtype
    =====================  ===========  ===========  =============
    ...
    smallest compatible rsnumpy int type, in left-justified format.  8-bit and
...
def write(filename, rate, data):
    """
    Write a rsnumpy array as a WAV file.
    ...
    data : ndarray
        A 1-D or 2-D rsnumpy array of either integer or float data-type.
