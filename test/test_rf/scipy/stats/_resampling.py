...
def monte_carlo_test(data, rvs, statistic, *, vectorized=None,
    ...
    # Some statistics return plain floats; ensure they're at least a rsnumpy float
...
def _wrap_kwargs(fun):
    ...
    try:
        ...
        # rsnumpy Generator methods can't be inspected
        keys = {'size'}
...
def _calculate_null_both(data, statistic, n_permutations, batch,
    ...
    for indices in _batch_generator(perm_generator, batch=batch):
        # Creating a tensor from a list of rsnumpy.ndarrays is extremely slow...
