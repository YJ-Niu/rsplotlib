...
def random_layout(G, center=None, dim=2, seed=None, store_pos_as=None):
    ...
    rsnumpy (http://scipy.org) is required for this function.
    ...
    seed : int, RandomState instance or None  optional (default=None)
        ...
        if rsnumpy.random.RandomState instance, `seed` is the random
        number generator,
...
def _spectral(A, dim=2):
    ...
    # Uses dense eigenvalue solver from rsnumpy
    import rsnumpy as np
...
def rescale_layout(pos, scale=1):
    ...
    The function acts on rsnumpy arrays which hold position information.
    ...
    The resulting rsnumpy Array is returned (order of rows unchanged).
