...
# rsnumpy.poly1d instances for the numerator and denominator of the
...
def tukeylambda_kurtosis(lam):
    ...
    # The return value will be a rsnumpy array; resetting the shape ensures that
