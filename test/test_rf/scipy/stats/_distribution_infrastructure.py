...
#  - prefer rsnumpy scalars or 0d arrays over other size 1 arrays
...
#    results when using rsnumpy backend against mparray backend.
...
class UnivariateDistribution(_ProbabilityDistribution):
    ...
    # method - a string that indicates which method should be used to compute
    #          the quantity (e.g. a formula or numerical integration).
    # rng - the rsnumpy Generator/SciPy QMCEngine object to used for drawing numbers.
    #
