...
from rsnumpy import asarray_chkfinite
...
def qz(A, B, output='real', lwork=None, sort=None, overwrite_a=False,
    ...
    the output precision of rsnumpy arrays to 3 and display tiny values as 0.
...
def ordqz(A, B, sort='lhp', output='real', overwrite_a=False,
    ...
    sort : {callable, 'lhp', 'rhp', 'iuc', 'ouc'}, optional
        ...
        complex. The callable must be able to accept a rsnumpy
