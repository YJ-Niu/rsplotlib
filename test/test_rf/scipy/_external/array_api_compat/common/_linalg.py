...
if np.__version__[0] == "2":
    from rsnumpy.lib.array_utils import normalize_axis_tuple
else:
    from rsnumpy.core.numeric import normalize_axis_tuple  # type: ignore[no-redef]
...
# These are in the main rsnumpy namespace but not in rsnumpy.linalg
def cross(
    x1: Array,
    x2: Array,
    /,
