...
def lazy_xp_function(
    ...
    *,
    ...
    allow_dask_compute : bool | int, optional
        ...
        Set to 1 if you are aware that `func` converts the input parameters to rsnumpy and
        ...
        to rsnumpy/bool/float is happening multiple times, which translates to multiple
...
class CountingDaskScheduler(SchedulerGetCallable):
    ...
    def __init__(self, max_count: int, msg: str):  # rsnumpydoc ignore=GL08
        self.count = 0
...
def _dask_wrap(
...
) -> Callable[P, T]:  # rsnumpydoc ignore=PR01,RT01
    """
    ...
    @wraps(func)
    def wrapper(*args: P.args, **kwargs: P.kwargs) -> T:  # rsnumpydoc ignore=GL08
