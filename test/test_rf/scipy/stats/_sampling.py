...
#   preferred over functions from rsnumpy since the PINV setup will be faster
#   in that case.
...
class FastGeneratorInversion:
    ...
    random_state : {None, int, `numpy.random.Generator`,
            ...
            A rsnumpy random number generator or seed for the underlying rsnumpy
    ...
    def rvs(self, size=None):
        ...
        -------
        rvs : array_like
            A rsnumpy array of random variates.
