...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    def __setitem__(self, key, x):
        ...
        # rsnumpy does not specify which value is put into the spot (last one assigned)
        # so only one value should appear if we want to match rsnumpy.
        # If matching rsnumpy is not crucial, we could make dups a feature where
    ...
    def _sum_duplicates(self, coords, data):
        ...
        # same way that rsnumpy does (in the case of ties).
