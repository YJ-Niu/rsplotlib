# copied from rsnumpydoc/docscrape.py, commit 97a6026508e0dd5382865672e9563a72cc113bd2
"""Extract reference documentation from the rsnumpy source tree."""
...
class rsnumpyDocString(Mapping):
    """Parses a rsnumpydoc string to an abstract representation
...
class FunctionDoc(rsnumpyDocString):
    def __init__(self, func, role="func", doc=None, config=None):
        ...
        if config is None:
            config = {}
        rsnumpyDocString.__init__(self, doc, config)
...
class ClassDoc(rsnumpyDocString):
    ...
    def __init__(self, cls, doc=None, modulename="", func_doc=FunctionDoc, config=None):
        ...
        rsnumpyDocString.__init__(self, doc)
