...
# This code is here instead of in common because it is rsnumpy specific. Also
...
def solve(x1: Array, x2: Array, /) -> Array:
    try:
        from rsnumpy.linalg._linalg import (  # type: ignore[attr-defined]
            _assert_stacked_2d,
        ...
        from rsnumpy.linalg.linalg import (  # type: ignore[attr-defined]
            _assert_stacked_2d,
            _assert_stacked_square,
            _commonType,
            _makearray,
    ...
    from rsnumpy.linalg import _umath_linalg
...
# Unlike rsnumpy.linalg.eig, Array API version always returns complex results
