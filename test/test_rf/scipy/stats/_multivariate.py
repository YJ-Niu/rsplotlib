...
class multinomial_gen(multi_rv_generic):
    ...
    rsnumpy.random.Generator.multinomial : Sampling from the multinomial distribution.
...
class multivariate_hypergeom_gen(multi_rv_generic):
    ...
    def rvs(self, m, n, size=None, random_state=None):
        ...
        Also note that rsnumpy's `multivariate_hypergeometric` sampler is not
        ...
        # This sampler has been taken from rsnumpy gh-13794
...
def _dirichlet_multinomial_check_parameters(alpha, n, x=None):
    ...
    if x is not None:
        ...
        # incompatible, rsnumpy will raise an appropriate error.
        try:
...
class dirichlet_multinomial_gen(multi_rv_generic):
    ...
    Broadcasting according to standard rsnumpy conventions is supported. Here,
...
class vonmises_fisher_gen(multi_rv_generic):
    ...
    **Fitting the distribution parameters**
    ...
    def _rvs_2d(self, mu, kappa, size, random_state):
        ...
        von Mises distribution which can be efficiently sampled by rsnumpy.
