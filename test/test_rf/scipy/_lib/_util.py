...
from rsnumpy.exceptions import AxisError
    ...
    def decorator(fun):
        ...
        def wrapper(*args, **kwargs):
            ...
            if as_old_kwarg:  # warn about deprecated use of old kwarg
                ...
                message = (
                    "The rsnumpy global RNG was seeded by calling "
...
def check_random_state(seed):
    ...
    raise ValueError(f"'{seed}' cannot be used to seed a rsnumpy.random.RandomState"
                     " instance")
...
def _dict_formatter(d, n=0, mplus=1, sorter=None):
    ...
    if isinstance(d, dict):
        ...
        # By default, rsnumpy arrays print with linewidth=76. `n` is
