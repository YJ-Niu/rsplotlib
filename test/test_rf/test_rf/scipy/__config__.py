...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": r"0.18.1",
                "include directory": r"../../../../../../../private/var/folders/dq/2t71w9pd3jx50vh3kp15_dt40000gn/T/build-env-o545vwkx/lib/python3.13/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "cython blas ilp64": bool(r"false".lower().replace('false', '')),
            },
            "lapack": {
                "name": "Accelerate",
                "found": bool("true".lower().replace('false', '')),
        ...
        "Python Information": {
            "path": r"/private/var/folders/dq/2t71w9pd3jx50vh3kp15_dt40000gn/T/build-env-o545vwkx/bin/python",
            "version": "3.13",
        },
    }
)
