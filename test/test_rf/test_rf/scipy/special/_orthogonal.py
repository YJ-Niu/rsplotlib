...
from rsnumpy import (exp, inf, pi, sqrt, floor, sin, cos, around,
...
def roots_laguerre(n, mu=False):
    ...
    --------
    scipy.integrate.fixed_quad
    rsnumpy.polynomial.laguerre.laggauss
...
def roots_hermite(n, mu=False):
    ...
    --------
    scipy.integrate.fixed_quad
    rsnumpy.polynomial.hermite.hermgauss
    roots_hermitenorm
...
def roots_hermitenorm(n, mu=False):
    ...
    --------
    scipy.integrate.fixed_quad
    rsnumpy.polynomial.hermite_e.hermegauss
...
def roots_chebyt(n, mu=False):
    ...
    --------
    scipy.integrate.fixed_quad
    rsnumpy.polynomial.chebyshev.chebgauss
...
def roots_legendre(n, mu=False):
    ...
    --------
    scipy.integrate.fixed_quad
    rsnumpy.polynomial.legendre.leggauss
