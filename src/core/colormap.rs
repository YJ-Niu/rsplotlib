...
// ColorBrewer 发散型 (diverging) 色板，11 级插值。低端 -> 高端。
const RDBU: [(f64, u8, u8, u8); 11] = [
    (0.0, 103, 0, 31),
    (0.1, 178, 24, 43),
    (0.2, 214, 96, 77),
    (0.3, 244, 165, 130),
...
colormap_fn!(rdbu_color, RDBU);

const RDYLBU: [(f64, u8, u8, u8); 11] = [
    (0.0, 165, 0, 38),
    (0.1, 215, 48, 39),
    (0.2, 244, 109, 67),
    (0.3, 253, 174, 97),
...
colormap_fn!(rdylbu_color, RDYLBU);

const RDYLGN: [(f64, u8, u8, u8); 11] = [
    (0.0, 165, 0, 38),
    (0.1, 215, 48, 39),
    (0.2, 244, 109, 67),
    (0.3, 253, 174, 97),
...
colormap_fn!(rdylgn_color, RDYLGN);

const RDGY: [(f64, u8, u8, u8); 11] = [
    (0.0, 103, 0, 31),
    (0.1, 178, 24, 43),
    (0.2, 214, 96, 77),
    (0.3, 244, 165, 130),
...
colormap_fn!(rdgy_color, RDGY);

const PUOR: [(f64, u8, u8, u8); 11] = [
    (0.0, 127, 59, 8),
    (0.1, 179, 88, 6),
    (0.2, 224, 130, 20),
    (0.3, 253, 184, 99),
...
colormap_fn!(puor_color, PUOR);

const BRBG: [(f64, u8, u8, u8); 11] = [
    (0.0, 84, 48, 5),
    (0.1, 140, 81, 10),
    (0.2, 191, 129, 45),
    (0.3, 223, 194, 125),
...
colormap_fn!(brbg_color, BRBG);

const PIYG: [(f64, u8, u8, u8); 11] = [
    (0.0, 142, 1, 82),
    (0.1, 197, 27, 125),
    (0.2, 222, 119, 174),
    (0.3, 241, 182, 218),
...
colormap_fn!(piyg_color, PIYG);

const PRGN: [(f64, u8, u8, u8); 11] = [
    (0.0, 64, 0, 75),
    (0.1, 118, 42, 131),
    (0.2, 153, 112, 171),
    (0.3, 194, 165, 207),
...
pub fn colormap_color(name: &str, t: f64) -> RGBColor {
    ...
    match name {
        ...
        "RdBu" => rdbu_color(t),
        "RdYlBu" => rdylbu_color(t),
        "RdYlGn" => rdylgn_color(t),
        "RdGy" => rdgy_color(t),
        "PuOr" => puor_color(t),
        "BrBG" => brbg_color(t),
        "PiYG" => piyg_color(t),
