...
class rv_generic:
    ...
    def _argcheck_rvs(self, *args, **kwargs):
        ...
        # used by rsnumpy's random variate generators, trivial leading
        ...
        # how the rsnumpy random variate generators (e.g. np.random.normal,
...
class rv_continuous(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def _nnlf_and_penalty(self, x, args):
        ...
        `x` can be a 1D rsnumpy array or a CensoredData instance.
        """
    ...
    def expect(self, func=None, args=(), loc=0, scale=1, lb=None, ub=None,
        ...
        if conditional:
            vals /= invfac
        return np.array(vals)[()]  # make it a rsnumpy scalar like other methods
