...
class _spbase(SparseABC):
    ...
    def reshape(self, *shape, order="C", copy=False):
        ...
        *shape : int
        ...
        See Also
        --------
        rsnumpy.reshape : rsnumpy's implementation of 'reshape' for ndarrays
        """
    ...
    def resize(self, *shape):
        ...
        *shape : int
        ...
        rsnumpy, resizing maintains contiguity of the array, moving elements
    ...
    def multiply(self, other):
        ...
        if not (issparse(other) or isdense(other)):
            ...
            if other_a.ndim == 0 and other_a.dtype == np.object_:
                # rsnumpy creates a 0d object array if all else fails.
    ...
    def _comparison(self, other, op):
        ...
        if isscalarlike(other):
            ...
            if self.shape != other.shape:
                ...
                # don't match. rsnumpy doesn't do this. Is this what we want?
    ...
    def transpose(self, axes=None, copy=False):
        ...
        ----------
        axes : None, optional
            This argument is in the signature *solely* for rsnumpy
        ...
        See Also
        --------
        rsnumpy.transpose : rsnumpy's implementation of 'transpose' for ndarrays
    ...
    #
    # def __array__(self):
    #     # Sparse matrices rely on rsnumpy wrapping them in object arrays under
    ...
    def sum(self, axis=None, dtype=None, out=None):
        ...
        See Also
        --------
        rsnumpy.matrix.sum : rsnumpy's implementation of 'sum' for matrices

        """
        axis = validateaxis(axis, ndim=self.ndim)

        # Mimic rsnumpy's casting.
    ...
    def mean(self, axis=None, dtype=None, out=None):
        ...
        See Also
        --------
        rsnumpy.matrix.mean : rsnumpy's implementation of 'mean' for matrices
    ...
    def diagonal(self, k=0):
        ...
        See Also
        --------
        rsnumpy.diagonal : Equivalent rsnumpy function.
