...
def _inspect_cell_array(ndarray):
    """Construct lists from cell arrays (loaded as rsnumpy ndarrays), recursing
...
def to_writeable(source):
    ...
    if isinstance(source, np.generic):
        # rsnumpy scalars are never mappings
        pass
...
class MatFile5Writer:
    ...
    def put_variables(self, mdict, write_header=None):
        ...
        mdict : mapping
           ...
           ``contents`` is something writeable to a matlab file, such as a rsnumpy
           array.
