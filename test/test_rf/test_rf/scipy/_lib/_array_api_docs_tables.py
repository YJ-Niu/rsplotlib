...
def _process_capabilities_table_entry(
    ...
    dict[str, dict[str, bool]]
        ...
        dict keyed on "cpu"). Only alternative backends to rsnumpy are
        included since rsnumpy support should be guaranteed.
...
def make_flat_capabilities_table(
    ...
    output : list[dict[str, str]]
        ...
        `backend_type`, e.g. jax.numpy, torch, and dask on cpu.
         rsnumpy is excluded because it should always be supported.
